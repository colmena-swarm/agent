...
public class ServiceDescriptionConverter {
    ...
    public static ServiceDescription convert(RouteGuide.ServiceDescription serviceDescription) {
        return FromGrpc.convert(serviceDescription);
    }

    public static RouteGuide.ServiceDescription convert(ServiceDescription serviceDescription) {
        return ToGrpc.convert(serviceDescription);
    }
}
